...
export default function PopupEditDetails(props) {
  ...
  return (
    <div className={`popup-edit-details--popup ${props.active || 'dis-none'} `}>
      <div className="popup-edit-details--popup">
        <div className="edit-details--popup">
          ...
          <div className="edit-details--popup--info">
            <input placeholder={props.jobtitle} />

            <label htmlFor="">Job Title</label>
          </div>

          <div className="edit-details--popup--info">
            <input type="text" placeholder={props.shiftStartAt || '00:00 '} />

            <label htmlFor="">Shift Start at</label>
          </div>
          <div className="edit-details--popup--info">
            <input type="text" placeholder={props.shiftEndAt || '00:00 '} />
